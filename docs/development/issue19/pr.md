...
<!-- template=pr version=93bb9b4e created=2026-07-09T10:56Z updated= -->
# docs: Bootstrap phase-gate-mcp and project documentation #19

This PR bootstraps the ypsia workspace's core documentation and coding standards using the latest phase-gate-mcp templates. It resolves the onboarding search puzzle by adding a central docs/README.md index, a root README.md homepage, relocating CHARTER.md, and removes all obsolete reference directories and legacy branding.
## Changes
Removed legacy .st3/ and agent.md files, cleaned up docs/reference/mcp/, copied updated coding standards to docs/coding_standards/, relocated CHARTER.md to docs/CHARTER.md, generalized contracts.yaml, added docs/README.md onboarding entry point, added root README.md project homepage, and replaced AthleteCanvas and st3/s1mpletrader references with ypsia.
...
- [ ] docs/README.md onboarding index created with relative links
- [ ] root README.md project homepage created with relative links
...
- **[README.md][related-2]**
- **[docs/README.md][related-3]**
- **[docs/CHARTER.md][related-4]**
- **[docs/coding_standards/README.md][related-5]**
